...
<html lang="en" class="no-js one-page-layout" data-mobile-classic-layout="true" data-classic-layout="false" data-prev-animation="16" data-next-animation="15" data-random-animation="false">
    ...
    <head>
        ...
        <meta name="Jhotay" content="hi this is jhotay a designer a developer a programer ">
        <meta name="keywords" content="Jhotay, best designer,top level web designer in bangladsh,top level web designer in bd,freelancer bd, portfolio, nasiruzzaman jhotay, alo kito ondokar,nasiruzzaman jote, nasiruzzaman joty, Nasiruzzaman alo, jhotayex,jhotay alo,infamous alo,prince of bangladesh,creative coder bangladesh,bd most wanted designer">
        <meta name="Jhotay" content="EPIC.IT">
        <meta name="google-site-verification" content="-giwnSbKeK82cNkdcl2JYFoj_fI4p_d7Oi8aZ8PqSO4" />
	<meta name="msvalidate.01" content="1E7570AC25D2243C3E3D98CC75EDD508" />

        <title>JHOTAY</title>

        <!-- FAV and TOUCH ICONS -->
        <link rel="apple-touch-icon" href="images\ico\icon.jpg">
        ...
        <link rel="stylesheet" type="text/css" href="768.css">
	...
	<script src="jquery-1.12.1.min.js"></script>
		...
		<script>
		 typist = document.querySelector "#typist-element2"
    new Typist typist,
  letterInterval: 60
  textInterval:   10000
	...
	<body>
		...
		<div id="page" class="hfeed site">
            ...
            <header id="masthead" class="header" role="banner">
                ...
                <div class="header-wrap">
                    ...
                    <div class="header-bottom">
                        ...
                        <ul class="social">
                            <li>
                                <a class="facebook" href="https://facebook.com/Mdjhotay"></a>
                            </li>
                            <li>
                                <a class="twitter" href="https://instagram.com/jhotayex"></a>
                            </li>
                            <li>
                                <a class="linkedin" href="http://linkedin.com/in/jhotay"></a>
                            </li>
                            <li>
                                <a class="instagram" href="http://instagram.com/jhotayex"></a>
                            </li>
                        </ul>
                        <!-- SOCIAL -->
		  ...
		  <div id="main" class="site-main">
                ...
                <!-- PAGE : HOME -->
                <section id="home" class="pt-page page-layout light-text home-section has-bg-img" style="background-image:url(images/site/home.jpg);position:fixed">
                	<!-- .content -->
                    <div class="content">
                    	<!-- .layout-medium -->
                        <div class="layout-medium">
                            ...
                            <h4>Hi, I am</h4>
                            <h2>MD Nasiruzzaman <bold id="typist-element2" data-typist="Jote, ALO">Jhotay</bold></h2>
                            <h4>I am <strong id="typist-element" data-typist="a Developer., a Programmer., a Digital artist.">a designer</strong></h4>               
    					</div>
                        <!-- .layout-medium -->
                    </div>
                    <!-- .content -->
                ...
                <section id="about" class="pt-page page-layout">
                    ...
                    <div class="content">
                        ...
                        <div class="layout-medium">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    ...
                                    <div class="service">
                                        ...
                                        <h4>Management</h4>
                                        <p>I work about web,apps,database. It is a long established fact that a reader will be distracted by the readable content.</p>
                                    </div>
                                    <!-- service -->
                            ...
                            <!-- section-title -->
                            <div class="section-title center" style="display:none">    
                                <h2>
                                    <i>Mice page EE</i>
                                </h2>
                            </div>
                        ...
                        <div class="layout-medium">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <div class="event">
                                        <h3>Feb 2016- Dec 13th</h3>
                                        <h4>Front End Web Developer</h4>
                                        <h5>EPIC.WEB / COMDEX it ltd</h5>
                                        <p>My last work for EPIC.WEB creative studio. I create usable web interfaces, front end coding stuff and almost anything. But i love what i do.</p>
                                    </div>
    
    
                                    <div class="event">
                                        <h3>Jan 2015 - Jan 2016</h3>
                                        <h4>Web Designer</h4>
                                        <h5>Creative IT .LTD</h5>
                                        <p>I worked as a Web Designer at Creative IT .LTD for 1 years. I create usable web interfaces, front end coding stuff and almost anything. But i love what i do.</p>
                                    </div>
									...
									<div class="event">
                                        <h3>2006 - present</h3>
                                        <h4>Freelancer</h4>
                                        <h5>upwork , freelancer , fiverr , truelancer</h5>
                                        <p>I am an Elite Author at Envato. I create usable web interfaces, front end coding stuff and almost anything. But i love what i do.</p>
                                    </div>
                                    ...
                                    <div class="event">
                                        ...
                                        <h5>National Science research and techonology NSRTC</h5>
                                        <p>I studied Diploma In Computer Science National Science research and techonology NSRTC..</p>
                                    </div>
                                    ...
                                    <div class="event">
                                        ...
                                        <h5>FIU BD</h5>
                                        <p>I finished my software engineering FIU. i have a well knowladge about software programing</p>
                                    </div>
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <!-- Testimonial -->
                                    <div class="testo">
                                        <img src="images\site\testo-01.jpg" alt="someone">
                                        <h4>Vincent Wood</h4>
                                    ...
                                    <!-- Testimonial -->
                                    <div class="testo">
                                        <img src="images\site\testo-02.jpg" alt="someone">
                                        <h4>Gary Morgan</h4>
                                    ...
                                    <!-- Testimonial -->
                                    <div class="testo">
                                        <img src="images\site\testo-03.jpg" alt="someone">
                           ...
                           <!-- <div class="media-cell illustration hentry">
                            ...
                            <!-- portfolio-item -->
    						 <div class="media-cell media image hentry">
                                <div class="media-box">
                                    ...
                                    <div class="mask"></div>
                                    <!-- lightbox - gallery -->
                                    <a href="images\portfolio\web1.jpg" class="lightbox" title="Resposnive wedsite for mobile company"></a>
                                    <a href="images\portfolio\web2.jpg" class="lightbox" title="Creative JQ Coming soon theme"></a>
                                    <a href="images\portfolio\web3.jpg" class="lightbox" title="Sites for Android community"></a>
                                    <a href="images\portfolio\web4.jpg" class="lightbox" title="Wordpess blog site"></a>
                                    <a href="images\portfolio\web5.jpg" class="lightbox" title="An App Page"></a>
                                    <a href="images\portfolio\web6.jpg" class="lightbox" title="Nove corp camical website"></a>
                                    <!-- lightbox - gallery -->
                                </div>
                                <div class="media-cell-desc">
                                    <h3>Web design</h3>
                                    <p class="category">Web design and developments</p>
                                </div>
                            </div>
                            ...
                            <div class="media-cell illustration video hentry">
                                ...
                                <div class="media-box">
                                    ...
                                    <div class="mask"></div>
                                    <!-- lightbox - video -->
                                    <a href="fblive.html" title="live TV" class="lightbox mfp-iframe"></a>
                                    <!-- lightbox - video -->
                                </div>
    
                                <div class="media-cell-desc">
                                    <h3>Online video</h3>
                                    <p class="category">Video editing gfx</p>
                                </div>
                            ...
                            <div class="media-cell media image hentry">
                                <div class="media-box">
                                    ...
                                    <div class="mask"></div>
                                    <!-- lightbox - image -->
                                    <a href="https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Fjhotayalo%2Fvideos%2F1499951646684669%2F&show_text=0&width=560" title="www.jhotaybd.ml" class="lightbox mfp-iframe"></a>
                                    <!-- lightbox - image -->
                                </div>
                                <div class="media-cell-desc">
                                    <h3>Facebook live</h3>
                                    <p class="category">Watch facebook live stream , spots live , media live</p>
                                </div>
                            </div>
                            <!-- portfolio-item - lightbox image -->
                            ...
                            <div class="media-cell illustration audio hentry">
                                <div class="media-box">
                                    ...
                                    <a href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/210862270&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true" title="Soundcloud embed" class="lightbox mfp-iframe"></a>
                            ...
                            <div class="media-cell illustration url hentry">
                                <div class="media-box">
                                    ...
                                    <div class="mask"></div>
                                    <a href="http://instagram.com/jhotayex" target="_blank"></a>
                                </div>
                                <div class="media-cell-desc">
                                    <h3>Shinny Robot</h3>
                        ...
                        <div class="latest-posts media-grid masonry" data-layout="masonry" data-item-width="340">
                            ...
                            <article class="hentry media-cell">
                                ...
                                <header class="media-cell-desc">
                                    ...
                                    <h3>
                                        <a href="owl2\index.html">OWl carasol 2 slider</a>
                                    </h3>
                                </header>
                            ...
                            <article class="hentry media-cell">
                                ...
                                <div class="media-box">
                                    <img src="images\blog\07.jpg" alt="post-image">
                                    <div class="mask"></div>
                                    <a href="blog-single.html"></a>
                                </div>
                            ...
                            <article class="hentry media-cell">
                                ...
                                <div class="media-box">
                                    <img src="images\blog\08.jpg" alt="post-image">
                                    <div class="mask"></div>
                                    <a href="blog-single.html"></a>
                                </div>
                            ...
                            <article class="hentry media-cell">
                                ...
                                <div class="media-box">
                                    <img src="images\blog\09.jpg" alt="post-image">
                                    <div class="mask"></div>
                                    <a href="blog-single.html"></a>
                                </div>
                        ...
                        <div class="layout-medium">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    ...
                                    <div class="fun-fact">
                                        ...
                                        <!--<img src="images/site/icon-03.png" alt="image"/>-->
                                        <h4>Kolabagan, Dhaka 1205, Bangladesh</h4>
                                    </div>
                                    <!-- fun-fact -->
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    ...
                                    <div class="fun-fact">
                                        ...
                                        <h4>Tel : +88 0177 3324 000<br>
										    Tel 2:+88 01839 840 280
										</h4>
                                    </div>
                                    <!-- fun-fact -->
                           ...
                           <!--  <div class="contact-form">
                                ...
                                <form id="contact-form" class="validate-form" method="post" action="send-mail.php">
                                    ...
                                    <p>
                                      <button class="submit button" href="jhotaysoft@gmail.com">Send a massage</button>
                                    </p>
